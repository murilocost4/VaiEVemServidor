...
public class Condutor extends Usuario implements Serializable {
    ...
    public Condutor(int codUsuario, String nomeUsuario, String cpf, Date nascimento, String endereco, String senha, String email, String fone) {
        super(codUsuario, nomeUsuario, cpf, nascimento, endereco, senha, email, fone);
    }

    public Condutor(String nomeUsuario, String cpf, Date nascimento, String endereco, String senha, String email, String fone) {
