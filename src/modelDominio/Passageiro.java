...
public class Passageiro extends Usuario implements Serializable {
    ...
    public Passageiro(int codUsuario, String nomeUsuario, String cpf, Date nascimento, String endereco, String senha, String email, String fone) {
        super(codUsuario, nomeUsuario, cpf, nascimento, endereco, senha, email, fone);
    }

    public Passageiro(String nomeUsuario, String cpf, Date nascimento, String endereco, String senha, String email, String fone) {
